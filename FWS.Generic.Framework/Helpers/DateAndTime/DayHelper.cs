...
namespace FWS.Generic.Framework.Helpers.DateAndTime
{
    public static class DayHelper
    {
        ...
        public static int DaysBetween(this DateTime startDate, DateTime endDate, bool daysFullInclusive = true)
        {
            var daysBetween = startDate.Date.Subtract(endDate.Date).TotalDays;

            if (daysFullInclusive) daysBetween++; //For example, days between the same datetime = 1

            return Convert.ToInt32(daysBetween);
        }
